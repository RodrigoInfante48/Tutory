...
insert into public.class_sessions (id, student_id, teacher_id, scheduled_date, status, notes) values
  -- Ana – taken
  ('ffffffff-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000002', now() - interval '7 days',  'taken',     'Great progress on Unit 1.'),
  ('ffffffff-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000002', now() - interval '3 days',  'taken',     null),
  ('ffffffff-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000002', now() + interval '2 days',  'scheduled', null),
  -- Pedro – upcoming
  ('ffffffff-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000002', now() - interval '5 days',  'taken',     null),
  ('ffffffff-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000002', now() + interval '4 days',  'scheduled', null),
  -- María (Carlos)
  ('ffffffff-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000003', now() - interval '2 days',  'no_show',   null),
  ('ffffffff-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000003', now() + interval '5 days',  'scheduled', null),
  -- Juan (Carlos)
  ('ffffffff-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000003', now() - interval '10 days', 'taken',     null),
  ('ffffffff-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000003', now() + interval '1 day',   'scheduled', null)
on conflict (id) do nothing;
